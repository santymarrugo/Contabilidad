...
WebUI.delay(1)
//Seleccionamos como moneda el Dolar
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Empresas/Asientos automaticos/Diferencias de cambio/DropDMoneda'), '2', false)
WebUI.delay(1)
//Seleccionamos el mes de enero de 2020, que es el mes de prueba
...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Empresas/Asientos automaticos/Diferencias de cambio/InputFechaCotizaciones'), '01/2020')
WebUI.delay(1)
...
WebUI.verifyTextPresent('Miércoles 1', false)
WebUI.delay(1)
WebUI.verifyTextPresent('Viernes 31', false)
WebUI.delay(1)
