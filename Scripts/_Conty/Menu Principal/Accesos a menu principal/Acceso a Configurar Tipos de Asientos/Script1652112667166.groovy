 ...
 * QA : Santiago Marrugo
 * Descripcion : Caso para accesar a la opcion Configurar Tipos de Asientos
 */

//Inicio de sesion exitoso
WebUI.callTestCase(findTestCase('_Conty/Login/Ingreso con usuario valido'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)
//Accesamos a la opcion Tipos de Asientos
...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/_Conty/Menu Principal/Accesos a menu principal/Sub-TabTiposDeAsientos'))
WebUI.delay(2)
//Verificamos que estemos en la ventana de Tipos de Asientos
WebUI.verifyTextPresent('Tipos de Asiento', false)