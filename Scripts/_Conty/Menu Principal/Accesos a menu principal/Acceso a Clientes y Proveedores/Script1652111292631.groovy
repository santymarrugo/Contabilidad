 ...
 * QA : Santiago Marrugo
 * Descripcion : Caso para accesar a la opcion Clientes y Proveedores
 */

//Inicio de sesion exitoso
WebUI.callTestCase(findTestCase('_Conty/Login/Ingreso con usuario valido'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)
//Accesamos a la opcion Clientes y proveedores
...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/_Conty/Menu Principal/Accesos a menu principal/Sub-TabClientesProveedores'))
WebUI.delay(2)
//Verificamos que estemos en la ventana de Clientes y proveedores
