 ...
 * QA : Santiago Marrugo
 * Descripcion : Caso para accesar a la opcion Plan de Cuentas del Menu Principal
 */

//Inicio de sesion exitoso
WebUI.callTestCase(findTestCase('_Conty/Login/Ingreso con usuario valido'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)
//Accesamos a la opcion Plan de cuentas
...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/_Conty/Menu Principal/Accesos a menu principal/Sub-TabPlandeCuentas'))
WebUI.delay(2)
//Verificamos que estemos en la ventana de Plan de cuentas
