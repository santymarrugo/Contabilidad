...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/_Conty/Menu Principal/Accesos a menu principal/Sub-TabAsientosAutomaticosDiferenciaCambio'))
WebUI.delay(2)
//Verificamos que estemos en la ventana de Diferencia de Cambio
WebUI.verifyTextPresent('Diferencias de cambio', false)