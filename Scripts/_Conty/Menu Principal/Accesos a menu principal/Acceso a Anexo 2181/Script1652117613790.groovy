 ...
 * QA : Santiago Marrugo
 * Descripcion : Caso para accesar a la opcion Anexo 2181
 */
...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/_Conty/Menu Principal/Accesos a menu principal/Sub-TabAnexo2181'))
WebUI.delay(2)
//Verificamos que estemos en la ventana de Importar Archivos
WebUI.verifyTextPresent('Generar anexo 2181', false)