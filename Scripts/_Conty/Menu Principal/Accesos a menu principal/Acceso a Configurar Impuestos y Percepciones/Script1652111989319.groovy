 ...
 * QA : Santiago Marrugo
 * Descripcion : Caso para accesar a la opcion Impuestos y Percepciones
 */

//Inicio de sesion exitoso
WebUI.callTestCase(findTestCase('_Conty/Login/Ingreso con usuario valido'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(1)
//Accesamos a la opcion Impuestos y percepciones
...
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/_Conty/Menu Principal/Accesos a menu principal/Sub-TabConfiguracionImpuestosPercepciones'))
WebUI.delay(1)
//Verificamos que estemos en la ventana de Lotes de Monedas
