...
//Cambiamos el dia del asiento por un 5, sin importar si ya tiene asignado un 5 en la celda
...
WebUI.delay(0.5)
WebUI.executeJavaScript('hot.setDataAtCell(2,5,"5")', null)

//Cambiamos la moneda del asiento por un 0, sin importar si ya tiene asignado un 0 en la celda
