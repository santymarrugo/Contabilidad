...
WebUI.delay(1)
//Seleccionamos como moneda el Peso argentino
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Empresas/Asientos automaticos/Diferencias de cambio/DropDMoneda'), '3', false)
WebUI.delay(1)
...
assert dia11 == '0.43161'
println(dia5)
println(dia11)

//Verificamos que la cotizacion sea en Pesos Argentinos
WebUI.verifyTextPresent('Cotizaciones $AR - 01/2022', false)
WebUI.delay(0.5)