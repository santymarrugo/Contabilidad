...
//Se verifican las cotizaciones en Dolares del mes de enero de 2022
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Compartidos/Verificar Cotizaciones - Dolares - 01-2022'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(0.5)
...
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Reportes Core/Diario A-2M-DE'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(0.5)
