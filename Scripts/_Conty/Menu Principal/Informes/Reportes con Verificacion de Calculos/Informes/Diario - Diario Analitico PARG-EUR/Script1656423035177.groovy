...
//Se verifican las cotizaciones en Pesos Argentinos del mes de enero de 2022
...
//Verificamos que el dia para generar este reporte sea 11 y que la moneda sea 1, es decir, dolares.
...
//Vamos ingresa a la opcion de Diarios
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Ingresos a Informes/Ingreso a Diarios'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(0.5)

/**
 * Para este siguiente paso existe un bug por esa razon se deja comentado, BUG # 248578
 */
//Configuramos las opciones, generamos el reporte y verificamos sus calculos
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Reportes Core/Diario A-2M-PARG-E'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(0.5)
