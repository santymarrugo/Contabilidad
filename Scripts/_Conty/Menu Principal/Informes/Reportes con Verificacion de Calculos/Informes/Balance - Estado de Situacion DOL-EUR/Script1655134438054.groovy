...
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Reportes Core/Balance EDS-2M-DE'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(0.5)
