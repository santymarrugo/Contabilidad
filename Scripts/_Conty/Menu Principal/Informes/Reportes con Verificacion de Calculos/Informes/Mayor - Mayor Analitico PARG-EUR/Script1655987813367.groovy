...
//Verificamos las cotizaciones en pesos argentinos del mes de enero de 2022
...
//Vamos ingresa a la opcion de Mayores

WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Ingresos a Informes/Ingreso a Mayores'), null)
WebUI.delay(0.5)

/**
 * Para este siguiente paso existe un bug por esa razon se deja comentado, BUG # 248007
 */
//Configuramos las opciones, generamos el reporte y verificamos sus calculos
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Reportes Core/Mayor A-2M-PARG-E'),[:], FailureHandling.STOP_ON_FAILURE)
