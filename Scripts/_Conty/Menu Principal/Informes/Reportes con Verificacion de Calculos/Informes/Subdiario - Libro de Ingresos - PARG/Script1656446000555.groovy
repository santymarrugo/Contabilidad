...
WebUI.delay(0.5)
WebUI.executeJavaScript("alert('COTIZACIONES EN PESOS ARGENTINOS VERIFICADAS CON EXITO')", null)
WebUI.delay(3)
WebUI.closeBrowser()
...
/**
 * Para este siguiente paso existe un bug por esa razon se deja comentado, BUG # 248797
 */

//Configuramos las opciones, generamos el reporte y verificamos sus calculos
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Reportes con Verificacion de Calculos/Reportes Core/Subdiario L-I-PARG'),[:], FailureHandling.STOP_ON_FAILURE)
