...
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/DDLibro'), '5', false)
WebUI.delay(1)
//Las fechas
//Inicial
...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/FechaInicial'), '01/01/2020')
WebUI.delay(1)
//Final
...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/FechaFinal'), '31/12/2021')
WebUI.delay(1)
...
def String tituloReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Subdiarios/LabelTituloReporteSubdiario CIE-D'))
println(tituloReporte)
assert tituloReporte == 'Caja ingresos y egresos'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Subdiarios/LabelPeriodoReporteSubdiadio CIE-D'))
println(periodoReporte)
assert periodoReporte == '01/01/2020 a 31/12/2021 en U$S'

WebUI.verifyTextPresent('Total U$S', false)
WebUI.delay(1)
