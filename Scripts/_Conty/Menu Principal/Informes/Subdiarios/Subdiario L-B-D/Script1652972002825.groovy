...
def String tituloReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Subdiarios/LabelTituloReporteLB-D'))
println(tituloReporte)
assert tituloReporte == 'Libro de Boletas'
WebUI.delay(1)

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Subdiarios/LabelPeriodoReporteLB-D'))
println(periodoReporte)
assert periodoReporte == '01/01/2022 a 31/01/2022 en U$S'
