...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/FechaInicial'), '01/04/2022')
WebUI.delay(1)
//Final
...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/FechaFinal'), '30/04/2022')
WebUI.delay(1)
...
assert periodoReporte == '01/04/2022 a 30/04/2022 en U$S'
