...
def String tituloReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Subdiarios/LabelTituloReporteSubdiario CIE-P'))
println(tituloReporte)
assert tituloReporte == 'Caja ingresos y egresos'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Subdiarios/LabelPeriodoReporteSubdiadio CIE-P'))
println(periodoReporte)
assert periodoReporte == '01/01/2020 a 31/12/2021 en $'

WebUI.verifyTextPresent('IVA $', false)
WebUI.delay(1)
