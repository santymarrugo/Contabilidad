...
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/DDLibro'), '2', false)
WebUI.delay(1)
//Las fechas
//Inicial
...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/FechaInicial'), '01/03/2022')
WebUI.delay(1)
//Final
...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Subdiarios/FechaFinal'), '31/03/2022')
WebUI.delay(1)
...
assert tituloReporte == 'Libro de Egresos'
WebUI.delay(1)
...
assert periodoReporte == '01/03/2022 a 31/03/2022 en U$S'
WebUI.delay(1)
