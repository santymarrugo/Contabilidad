...
WebUI.waitForElementPresent(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloMayor RPD-1M-D'), 20)
WebUI.delay(5)
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloMayor RPM-1M-D'))
println(tituloReporte)
assert tituloReporte == 'Mayor resumido por mes'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporteMayor RPM-1M-D'))
