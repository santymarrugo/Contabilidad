...
WebUI.waitForElementPresent(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloReporte'), 20)
WebUI.delay(1)
...
def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporte-Mayor A-1M-D'))
