...
WebUI.delay(1)
//Moneda en dolares
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/DDMonedaDos'), '2', false)
WebUI.delay(1)
//Apertura
...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloMayor COP-2M-PD-ConFiltroRUT'))
println(tituloReporte)
assert tituloReporte == 'Mayor por cliente o proveedor'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporteMayor COP-2M-PD-ConFiltroRUT'))
println(periodoReporte)
assert periodoReporte.trim() == '01/01/2022 a 31/01/2022. $ y U$S.'

WebUI.verifyTextPresent('Chispoteo S.A.', false)
WebUI.delay(1)
WebUI.verifyTextPresent('Haber U$S', false)
WebUI.delay(1)
