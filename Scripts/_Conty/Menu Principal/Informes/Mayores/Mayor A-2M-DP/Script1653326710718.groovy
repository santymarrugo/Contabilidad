...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloReporte'))
println(tituloReporte)
assert tituloReporte == 'Mayor analítico'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporte-Mayor A-2M-DP'))
