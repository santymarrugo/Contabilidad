...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloMayor COP-1M-D-SinFiltroRUT'))
println(tituloReporte)
assert tituloReporte == 'Mayor por cliente o proveedor'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporteMayor COP-1M-D-SinFiltroRUT'))
println(periodoReporte)
assert periodoReporte.trim() == '01/01/2022 a 31/01/2022. U$S.'
