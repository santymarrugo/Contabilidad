...
WebUI.delay(1)
//Moneda dos en pesos
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/DDMonedaDos'), '1', false)
WebUI.delay(1)
//Apertura
...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloMayor RPM-2M-DP'))
println(tituloReporte)
assert tituloReporte == 'Mayor resumido por mes'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporteMayor RPM-2M-DP'))
println(periodoReporte)
assert periodoReporte == '01/01/2022 a 31/01/2022. U$S y $'
