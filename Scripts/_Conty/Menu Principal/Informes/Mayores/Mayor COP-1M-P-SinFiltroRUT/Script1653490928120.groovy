...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Mayores/LabelTituloMayor COP-1M-P-SinFiltroRUT'))
println(tituloReporte)
assert tituloReporte == 'Mayor por cliente o proveedor'

def String periodoReporte = WebUI.getText(findTestObject('_Conty/Menu Principal/Informes/Mayores/LabelPeriodoReporteMayor COP-1M-P-SinFiltroRUT'))
