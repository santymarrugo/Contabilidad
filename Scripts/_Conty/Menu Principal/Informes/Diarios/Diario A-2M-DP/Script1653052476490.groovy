...
WebUI.delay(1)
//Moneda dos pesos
WebUI.selectOptionByValue(findTestObject('_Conty/Menu Principal/Informes/Diarios/DDMonedaDos'), '1', false)
WebUI.delay(1)
//Apertura
...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Diarios/LabelTituloReporte-A-2M-DP'))
println(tituloReporte)
assert tituloReporte == 'Diario analítico'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Diarios/LabelPeriodoReporte-A-2M-DP'))
println(periodoReporte)
assert periodoReporte == '01/01/2022 a 31/01/2022. U$S y $'

WebUI.verifyTextPresent('Debe U$S', false)
WebUI.delay(1)
