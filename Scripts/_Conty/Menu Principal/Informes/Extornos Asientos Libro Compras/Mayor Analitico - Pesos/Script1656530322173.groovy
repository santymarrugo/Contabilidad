...
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Accesos a menu principal/Acceso a Informes Mayores'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)

//Generacion del reporte
WebUI.callTestCase(findTestCase('_Conty/Menu Principal/Informes/Extornos Asientos Libro Compras/Reportes Core/Mayor A-1M-P'),[:], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(1)
