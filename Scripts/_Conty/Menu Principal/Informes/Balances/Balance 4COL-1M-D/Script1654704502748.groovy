...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance 4COL-1M-D'))
println(tituloReporte)
assert tituloReporte == 'Balance 4 columnas'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance 4COL-1M-D'))
