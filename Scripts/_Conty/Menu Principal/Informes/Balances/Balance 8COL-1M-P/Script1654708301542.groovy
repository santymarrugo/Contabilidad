...
WebUI.verifyTextPresent('Débitos $', false)
WebUI.verifyTextPresent('Créditos $', false)
WebUI.verifyTextPresent('Deudores $', false)
WebUI.verifyTextPresent('Acreedores $', false)
...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance 8COL-1M-P'))
println(tituloReporte)
assert tituloReporte == 'Balance 8 columnas'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance 8COL-1M-P'))
