...
WebUI.delay(1)
//Tipo de balance
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/DDTipoDeBalance'), '2', false)
WebUI.delay(1)
//Fecha inicial
...
WebUI.delay(1)
//Moneda pesos
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/DDMonedaDos'), '1', false)
WebUI.delay(1)
//Apertura
...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance EDR-2M-DP'))
println(tituloReporte)
assert tituloReporte == 'Estado de resultados'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance EDR-2M-DP'))
println(periodoReporte)
assert periodoReporte == '01/01/2020 a 31/12/2021. U$S y $'
