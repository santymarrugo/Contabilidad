...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance EDS-1M-D'))
println(tituloReporte)
assert tituloReporte == 'Estado de situación'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance EDS-1M-D'))
...
WebUI.executeJavaScript('alert("Reporte en DOLARES generado con exito")', null)
WebUI.delay(3)
