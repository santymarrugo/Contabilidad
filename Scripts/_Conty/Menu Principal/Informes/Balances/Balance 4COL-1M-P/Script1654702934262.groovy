...
WebUI.delay(1)
//Tipo de balance
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/DDTipoDeBalance'), '4', false)
WebUI.delay(1)
//Fecha inicial
...
WebUI.verifyTextPresent('Pasivo $', false)
WebUI.verifyTextPresent('Pérdidas $', false)
WebUI.verifyTextPresent('Ganancias $', false)
WebUI.delay(1)
//Verificamos la generacion correcta del reporte
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance 4COL-1M-P'))
println(tituloReporte)
assert tituloReporte == 'Balance 4 columnas'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance 4COL-1M-P'))
