...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance MYS-1M-P'))
println(tituloReporte)
assert tituloReporte == 'Movimiento y saldos'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance MYS-1M-P'))
println(periodoReporte)
assert periodoReporte == '01/01/2020 a 31/12/2021. $'

WebUI.verifyTextPresent('Saldo inicial $', false)
WebUI.delay(2)
