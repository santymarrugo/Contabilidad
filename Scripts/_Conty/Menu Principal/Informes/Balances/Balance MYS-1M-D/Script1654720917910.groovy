...
WebUI.delay(1)
//Tipo de balance
WebUI.selectOptionByValue(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/DDTipoDeBalance'), '6', false)
WebUI.delay(1)
//Fecha inicial
...
def String tituloReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelTituloReporte Balance MYS-1M-D'))
println(tituloReporte)
assert tituloReporte == 'Movimiento y saldos'

def String periodoReporte = WebUI.getText(findTestObject('Object Repository/_Conty/Menu Principal/Informes/Balances/LabelPeriodoReporte Balance MYS-1M-D'))
println(periodoReporte)
assert periodoReporte == '01/01/2020 a 31/12/2021. U$S'

WebUI.verifyTextPresent('Saldo inicial U$S', false)
WebUI.delay(2)
